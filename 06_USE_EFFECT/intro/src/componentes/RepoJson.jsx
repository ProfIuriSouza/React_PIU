...
export default function EffectAPI() {
  ...
  useEffect(() => {
    ...
    const fetchUsuarios = async () => {
      try {
        const response = await fetch('https://my-json-server.typicode.com/ProfIuriSouza/React_PIU/blob/master/06_USE_EFFECT/intro/db.json'); //fecth faz uma requisição HTTP utilizando o método GET
